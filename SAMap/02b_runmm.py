...
#cd /athena/abc/scratch/paz2005/projects/czi_samap
#conda activate sam-amp_v3 
...
data="/athena/abc/scratch/paz2005/projects/czi_samap_myeloid/sce_mm_myeloidOnly_counts_forSAMap_filtered.h5ad"
sam = SAM()
sam.load_data(data)
